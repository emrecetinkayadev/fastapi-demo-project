...
def test_get_posts__posts_found__return_posts(posts, mocker):
    patched_get_all = mocker.patch(
        'blog.posts.views.get_all', return_value=posts)
...
def test_update_post__post_updated__return_updated_post(post_in_put, post_in_get, mocker):
    ...
    patched_get = mocker.patch(
        'blog.posts.views.get', return_value=post_in_get)
    patched_update = mocker.patch(
        'blog.posts.views.update', return_value=updated_data)
